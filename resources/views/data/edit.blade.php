...
<div class="container">
    ...
    @method('PUT')
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="title" name="title" value="{{ $comic->title }}" maxlength="50" required>
        </div>
        <div class="mb-3">
            <label for="description" class="form-label">Description*</label>
            <textarea rows="3" class="form-control" id="description" name="description" value="{{ $comic->description }}" required>{{ $comic->description }}</textarea>
        </div>
        <div class="mb-3">
